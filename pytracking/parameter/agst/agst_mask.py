...
def parameters():
    ...
    ## IouNet parameters ##
    params.image_sample_size = 20*18
    params.search_area_scale1 = 5.5
    params.iou_refine_thr = 0.45             ## Relative threshold to perform bounding box refine
    ...
    params.segm_net_path = '/home/wcz/Yang/AGST/pytracking/networks/SegmNet.pth.tar'
    ...
    params.segm_surroundings_area_factor = 4.5 
    params.segm_update_skip = 30                          # How often to run segmentation updating (every n-th frame)
    ...
    params.sample_filter_thr = 0.2         # Relative threshold to filter samples for DCF training
    params.score_budget_sz = 5             # Memory size for saving the confidence scores of response map
    params.tracking_confidence_thr = 0.5   # Relative threshold to save the confidence scores    
