...
sys.path.append('/media/cqr/DATASSD/yang/AGST/')

from pytracking.tracker.feast_vot20 import AGST
from pytracking.parameter.feast import agst_mask as vot_params
