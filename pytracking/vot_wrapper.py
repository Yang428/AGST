...
sys.path.append('/home/wcz/Yang/AGST/')

from pytracking.tracker.feast_vot import AGST
from pytracking.parameter.feast import agst_vot as vot_params
...
while True:
    ...
    prediction = tracker.track(image)['target_bbox']
